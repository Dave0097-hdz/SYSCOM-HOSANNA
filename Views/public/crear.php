                        ...
                        <div class="col-lg-5">
                            <div class="card shadow-lg border-0 rounded-lg mt-5">
                                <div class="card-header">
                                    ...
                                    <div class="">
                                    <a class="btn btn-info text-center" href="iniciar.php">Ya tengo cuenta</a>
                                </div>
                                </div>
                                <?php
                                    ...
                                    <form method="POST" autocomplete="off">
                                        ...
                                        <div class="form-floating mb-3">
                                            <input class="form-control" name="telefono" value="<?php echo $telefono ?>"
                                                type="number" max="11" min="0"/>
                                            <label for="telefono">Telefono</label>
                                        </div>
                                        <div class="form-floating mb-3">
                                            <input class="form-control" name="direccion"
                                                value="<?php echo $direccion ?>" type="text" />
                                            <label for="direccion">Direccion</label>
                                        </div>
                                        <div class="form-floating mb-3">
                                            <input class="form-control" name="contraseña"
                                                value="<?php echo $contraseña ?>" type="password" />
                                            <label for="contraseña">Contraseña</label>
                                        </div>
                                        <div class="form-floating mb-3">
                                            <input class="form-control" name="confirmar"
                                                value="<?php echo $confirmar ?>" type="password" />
